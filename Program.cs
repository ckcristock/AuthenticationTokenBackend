...
var jwtSecret = builder.Configuration["JwtSettings:Secret"] ?? throw new InvalidOperationException("JWT Secret no configurado");
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Authentication Token Backend API",
        Version = "v1"
    });
